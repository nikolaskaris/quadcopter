...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=200, kernel_regularizer=layers.regularizers.l2(1e-6))(net_states)
        net_states = layers.Dropout(rate=0.1)(net_states)
        ...
        net_actions = layers.Dense(units=200,kernel_regularizer=layers.regularizers.l2(1e-6))(net_actions)
        net_actions = layers.Dropout(rate=0.1)(net_actions)
